...
function MockupDashboard() {
  return (
    <div className="relative w-full max-w-[480px] mx-auto">
        ...
        <div className="p-5 space-y-4">
          ...
          <div className="space-y-2">
            {[
              ...
              <div
                key={i}
                className={`flex items-center justify-between p-3 rounded-xl bg-gradient-to-r ${session.color} border border-white/[0.05]`}
              >
              ...
              <div className="flex-1 space-y-1.5">
                {["Mina", "Juno", "Alex"].map((name, i) => (
                  <div key={name} className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-semibold text-white/70 w-6 text-right">
                      {[42, 31, 24][i]}
                    </span>
                  </div>
                ))}
      ...
      {/* Floating cards */}
      <FloatingCard
        className="w-[150px] -left-12 top-16 z-20"
        delay={0.8}
        duration={7}
      >
      ...
      <FloatingCard
        className="w-[160px] -right-8 top-8 z-20"
        delay={1.0}
        duration={5.5}
      >
        <div className="flex items-center gap-2 mb-2">
      ...
      <FloatingCard
        className="w-[148px] -right-6 bottom-24 z-20"
        delay={1.2}
        duration={6.5}
      >
        <div className="flex items-center gap-2 mb-2">
        ...
        <div className="flex gap-1 mt-1.5">
          {["M", "J", "A", "Y"].map((initial) => (
            <div
              key={initial}
              className="w-5 h-5 rounded-full bg-gradient-to-br from-violet-500/50 to-indigo-500/50 flex items-center justify-center text-[8px] font-bold text-white/80"
            >
              {initial}
            </div>
          ))}
      ...
      <FloatingCard
        className="w-[152px] -left-10 bottom-16 z-20"
        delay={0.6}
        duration={8}
      >
        <div className="flex items-center gap-2 mb-2">
      ...
      {/* Background glow */}
      <div className="absolute inset-0 -z-10 blur-3xl opacity-30 rounded-full bg-gradient-to-br from-violet-600/40 via-indigo-600/30 to-blue-600/20" />
    </div>
  );
}
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div className="order-2 lg:order-1">
            ...
            <motion.h1
              ...
              className="text-[44px] sm:text-[54px] lg:text-[60px] font-bold leading-[1.08] tracking-[-0.03em] text-white mb-6"
            >
              당신의 플레이를,
              <br />
            ...
            <motion.p
              ...
              className="text-[16px] leading-relaxed text-white/50 mb-10 max-w-[460px]"
            >
